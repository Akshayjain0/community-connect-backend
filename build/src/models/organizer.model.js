...
const OrganizerSchema = new mongoose_1.Schema({
    ...
    created_projects: [{ type: mongoose_1.Schema.Types.String, ref: "Project" }], // UUIDs of projects
...
OrganizerSchema.methods.isPasswordCorrect = function (password) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield bcrypt_1.default.compare(password, this.password);
    });
};
OrganizerSchema.methods.generateAccessToken = function (role) {
...
OrganizerSchema.methods.generateRefreshToken = function (role) {
    return jsonwebtoken_1.default.sign({
        _id: this._id,
        role: role,
    }, process.env.TOKEN_SECRET, {
